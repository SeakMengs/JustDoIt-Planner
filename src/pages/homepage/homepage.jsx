...
export const HomePage = () => {
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-center bg-white-theme-1 dark:bg-dark-theme-1 h-screen max-w-full first-section">
            ...
            <div className="flex items-center justify-center bg-white-theme-2 dark:bg-dark-theme-2 h-screen max-w-full first-section">
                <div className="main max-w-7xl my-0 mx-auto max-sm:text-xs">
                    <div className="flex items-center justify-center max-sm:mx-1">
